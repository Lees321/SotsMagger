	...
	<body>
		<div class="dvheader">
			<div class="dvheadertools">
				<span class="headerspantitle">旅游后台管理系统</span>
				<ul class="headerultools">
					...
					<li class="headerlitools_info headerlitools" style="background-color: #075597">
						...
						${loginUser.userName }<i style="margin-left: 8px;" class="icon-caret-down"></i>
						<%-- <a style="color: black; text-decoration: none;" href="${ctx }/loginOut">退出</a> --%>
		...
		<div class="dvcontent">
			...
			<ul class="ulleftmenu" style="border-right: 1px solid #ddd;">
				...
				<li class="limenuitem">
					...
					<c:if test="${loginUser.ucid!=1 }" var="notAdmin">
							<a href="${ctx }/type/getList" target="right">
								<li>分类管理</li>
							</a>
							<a href="${ctx }/inbound/getAllList" target="right">
								<li>商品管理</li>
							</a>
							<a href="${ctx }/boud/getOutboudList" target="right">
								<li>博客管理</li>
							</a>
							<a href="${ctx }/Yonghu/getUserList" target="right">
								<li>用户管理</li>
							</a>
							
							<a href="updatePwd.jsp" target="right"><li >修改密码</li></a>
						</c:if>
			...
			<div style="position: absolute; left: 191px; right: 20px; " id="content_right">
				<%-- <%@ include file="type.jsp"%> --%>
				<%-- <jsp:include page="type.jsp"/> --%>
				<iframe src="main.jsp" scrolling="no"  width="100%" height="1200" name="right" border="none"></iframe>
			</div>
		</div>
		...
		<!-- <script type="text/javascript">
			$(function(){
				$(".ulleftsubitems>a").click(function(){
					...
					$.ajax({
						...
						success:function(data){
							$("#content_right").empty();
							$("#content_right").load(data+".jsp");
							/* alert($("#content_right").html());
							console.log(data); */
							//$("#showPage").attr("file",data+".jsp");
						},
						error:function(e){
							alert(e);
						}
