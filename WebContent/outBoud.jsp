		...
		<div class="dvcontent">
			...
			<div>
				...
				<div class="tabs" style="margin: 30px;">
					<div class="hd">
						<ul>
							<li class="on" style="box-sizing: initial;-webkit-box-sizing: initial;">查看博客</li>
	<li class="" style="box-sizing: initial;-webkit-box-sizing: initial;">添加博客</li>
						</ul>
					</div>
					<div class="bd">
								...
								<div id="dv1">
									<table class="table" id="tbRecord">
										...
										<tbody>
											...
											<c:forEach items="${pageInfo.list}" var="boud">
												<tr>
													<td>${boud.blogId }</td>
													<td>${boud.user.userName }</td>
													<td>${boud.blogTitle }</td>
													<td>${boud.user.userPhoto }</td>
													<td>${boud.blogCommentPhoto }</td>
													<td>${boud.blogComment }</td>
													...
													<td class="edit"><button onclick="btn_edit(${boud.blogId })" data-toggle="modal" data-target="#myModal"><i class="icon-edit bigger-120"></i>编辑</button></td>
													<td class="delete"><button onclick="btn_delete(${boud.blogId })"><i class="icon-trash bigger-120"></i>删除</button></td>
												</tr>
											</c:forEach>
									...
									<div id="div_pagination_bottom">
							            <nav aria-label="Page navigation">
							                <ul class="pagination">
							                     <li>
							                         <a href="${ctx}/boud/getOutboudList?currpage=${pageInfo.pageNum-1}"
							                           aria-label="Previous">
							                     ...
							                     <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
							                         ...
							                         <c:if test="${page_Num != pageInfo.pageNum }">
							                            <li>
							                                 <a style="margin-top: 7px;" href="${ctx}/boud/getOutboudList?currpage=${ page_Num}">${ page_Num}</a>
							                            </li>
							                        </c:if>
							                     </c:forEach>
							                    <li>
				...
				<div class="am-g">
					...
					<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4"
						...
						<form class="am-form am-form-horizontal"
							action="${ctx }/boud/addOutboud" method="post"  id="saveForm">
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input type="text" id="user-name" required
										placeholder="博客标题" name="blogTitle">
										<small>10字以内...</small>
								</div>
							</div>
								<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input type="text" id="user-name" required
										placeholder="博客内容" name="blogComment">
										<small>10字以内...</small>
								</div>
							</div>
								<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input type="text" id="user-name" required
										placeholder="博客图片" name="blogCommentPhoto">
										<small>10字以内...</small>
								</div>
								<div class="am-form-group">
								<label for="user-name" class="am-u-sm-3 am-form-label">
		...
		<div class="modal-dialog">
					...
					<form class="am-form am-form-horizontal" action="updateOutboud" method="post"
						...
						<input type="hidden" name="blogId" id="blogId" value=""/>
								...
								<label for="user-name" class="am-u-sm-3 am-form-label">
									博客内容</label>
								<div class="am-u-sm-9">
									<input type="text" id="blogComment" required
										placeholder="博客内容" name="blogComment">
										<small>10字以内...</small>
								</div>
							</div>
								...
								<label for="user-name" class="am-u-sm-3 am-form-label">
									博客图片</label>
								<div class="am-u-sm-9">
									<input type="text" id="blogCommentPhoto" required
										placeholder="博客图片" name="blogCommentPhoto">
										<small>10字以内...</small>
								</div>
								<div class="am-form-group">
			...
			<script>
				...
				$("#butUpdate").click(function(){
					...
					$.post("${ctx}/boud/updateOutboud",$("#updateForm").serialize(),function(data){
				...
				var btn_edit = function(id) {
					...
					$.get("${ctx}/boud/findById",{id:id},function(data){
						/* alert(data);
						console.log(data); */
						// 将这个json对象中的数据设置到页面上
						window.setTimeout(function(){
							...
							$("#blogComment").val(data.blogComment);
							$("#blogCommentPhoto").val(data.blogCommentPhoto);
